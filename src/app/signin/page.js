...
<div
  ...
  className="w-full bg-transparent text-foreground placeholder-muted-foreground outline-none border-none focus:outline-none focus:border-none focus:ring-0"
/>
